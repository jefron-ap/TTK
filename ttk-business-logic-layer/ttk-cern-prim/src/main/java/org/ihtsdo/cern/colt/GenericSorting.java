...
<p> Lets call the generic data <tt>g</tt> (it may be one array, three linked lists 
  ...
  with the data at index <tt>b</tt>. It calls a user provided {@link org.ihtsdo.cern.colt.Swapper} 
...
<p> Sorts involving floating point data and not involving comparators, like, for 
  ...
  org.ihtsdo.cern.colt.Sorting} handle floating point numbers in special ways to guarantee 
