...
import org.ihtsdo.cern.colt.bitvector.BitVector;
import org.ihtsdo.cern.colt.bitvector.QuickBitVector;
/**
 ...
 */
public class MinMaxNumberList extends org.ihtsdo.cern.colt.list.AbstractLongList {
...
public static int bitsPerElement(long minimum, long maximum) {
	...
	if (1+maximum-minimum > 0) {
		bits=(int) Math.round(Math.ceil(org.ihtsdo.cern.jet.math.Arithmetic.log(2,1+maximum-minimum)));
	}
	else {	
