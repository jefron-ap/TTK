...
import org.ihtsdo.cern.colt.function.ObjectProcedure;
/**
...
public int binarySearchFromTo(Object key, int from, int to, java.util.Comparator comparator) {
	return org.ihtsdo.cern.colt.Sorting.binarySearchFromTo(this.elements,key,from,to,comparator);
}
/**
...
public void trimToSize() {
	elements = org.ihtsdo.cern.colt.Arrays.trimToCapacity(elements,size());
}
}
