...
import org.ihtsdo.cern.colt.Timer;
 ...
 * @return int[]
 * @param list org.ihtsdo.cern.colt.list.DoubleArrayList
...
public static double epsilon(DoubleArrayList sortedList, double phi, double element) {
	double rank = org.ihtsdo.cern.jet.stat.Descriptive.rankInterpolated(sortedList,element);
 ...
 * @return double[]
 * @param values org.ihtsdo.cern.it.hepodbms.primitivearray.DoubleArrayList
 * @param phis double[]
 */
...
public static void testQuantileCalculation(String[] args) {
	...
	*/
	...
	if (computeExactQuantilesAlso) {
		...
		exactFinder.forEach(
			new org.ihtsdo.cern.colt.function.DoubleFunction() {
