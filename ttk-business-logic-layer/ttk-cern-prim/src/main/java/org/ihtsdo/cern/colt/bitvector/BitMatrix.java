 ...
 */
public class BitMatrix extends org.ihtsdo.cern.colt.PersistentObject {
 ...
 */
public boolean forEachCoordinateInState(boolean state, final org.ihtsdo.cern.colt.function.IntIntProcedure procedure) {
	/*
	...
	return vector.forEachIndexFromToInState(0,size()-1,state,
		new org.ihtsdo.cern.colt.function.IntFunction() {
