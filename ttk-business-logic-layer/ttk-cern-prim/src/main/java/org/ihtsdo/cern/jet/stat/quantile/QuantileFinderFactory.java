...
//import org.ihtsdo.cern.it.util.Doubles;
import org.ihtsdo.cern.jet.math.Arithmetic;
 ...
 */
public static org.ihtsdo.cern.colt.list.DoubleArrayList newEquiDepthPhis(int quantiles) {
	org.ihtsdo.cern.colt.list.DoubleArrayList phis = new org.ihtsdo.cern.colt.list.DoubleArrayList(quantiles-1);
