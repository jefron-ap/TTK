...
*/
package org.ihtsdo.cern.colt.bitvector;
 ...
 */
public class BitVector extends org.ihtsdo.cern.colt.PersistentObject {
	/*
	...
	private class IndexProcedure implements org.ihtsdo.cern.colt.function.IntProcedure {
 ...
 */
public boolean forEachIndexFromToInState(int from, int to, boolean state, org.ihtsdo.cern.colt.function.IntProcedure procedure) {
	/*
