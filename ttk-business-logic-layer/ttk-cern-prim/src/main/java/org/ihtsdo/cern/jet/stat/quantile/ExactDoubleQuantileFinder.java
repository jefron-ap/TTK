...
*/
package org.ihtsdo.cern.jet.stat.quantile;

import org.ihtsdo.cern.colt.list.DoubleArrayList;
/**
...
class ExactDoubleQuantileFinder extends org.ihtsdo.cern.colt.PersistentObject implements DoubleQuantileFinder {
 ...
 */
public boolean forEach(org.ihtsdo.cern.colt.function.DoubleProcedure procedure) {
...
public double phi(double element) {
	this.sort();
	return org.ihtsdo.cern.jet.stat.Descriptive.rankInterpolated(buffer,element) / this.size();
}
/**
...
public DoubleArrayList quantileElements(DoubleArrayList phis) {
	this.sort();
	return org.ihtsdo.cern.jet.stat.Descriptive.quantiles(this.buffer, phis);
	/*
