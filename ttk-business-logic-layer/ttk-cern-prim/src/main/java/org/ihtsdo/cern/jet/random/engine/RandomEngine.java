...
*/
package org.ihtsdo.cern.jet.random.engine;
 ...
 */
//public abstract class RandomEngine extends edu.cornell.lassp.houle.RngPack.RandomSeedable implements org.ihtsdo.cern.colt.function.DoubleFunction, org.ihtsdo.cern.colt.function.IntFunction {
public abstract class RandomEngine extends org.ihtsdo.cern.colt.PersistentObject implements org.ihtsdo.cern.colt.function.DoubleFunction, org.ihtsdo.cern.colt.function.IntFunction {
/**
...
public static RandomEngine makeDefault() {
	return new org.ihtsdo.cern.jet.random.engine.MersenneTwister((int) System.currentTimeMillis());
}
/**
