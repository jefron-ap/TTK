...
public class PrimeFinder extends Object {
	...
	static { //initializer
		...
		//new org.ihtsdo.cern.colt.list.IntArrayList(primeCapacities).mergeSort(); // for debug only, TODO
	}
...
public static int nextPrime(int desiredCapacity) {
	...
	//int i = new org.ihtsdo.cern.colt.list.IntArrayList(primeCapacities).binarySearch(desiredCapacity); // for debug only TODO
	if (i<0) {
