...
*/
package org.ihtsdo.cern.colt.map;

import org.ihtsdo.cern.colt.function.IntDoubleProcedure;
...
*/
public void assign(org.ihtsdo.cern.colt.function.DoubleFunction function) {
	// specialization for speed
	if (function instanceof org.ihtsdo.cern.jet.math.Mult) { // x[i] = mult*x[i]
		double multiplicator = ((org.ihtsdo.cern.jet.math.Mult)function).multiplicator;
