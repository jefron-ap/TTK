...
import org.ihtsdo.cern.jet.random.Uniform;
 ...
 */
public class WeightedRandomSampler extends org.ihtsdo.cern.colt.PersistentObject {
...
public WeightedRandomSampler(int weight, RandomEngine randomGenerator) {
	if (randomGenerator==null) randomGenerator = org.ihtsdo.cern.jet.random.AbstractDistribution.makeDefaultGenerator();
