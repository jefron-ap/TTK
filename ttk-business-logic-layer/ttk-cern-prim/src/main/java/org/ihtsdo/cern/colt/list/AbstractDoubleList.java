...
*/
public abstract class AbstractDoubleList extends AbstractList implements org.ihtsdo.cern.colt.buffer.DoubleBufferConsumer {
	/**
...
public void shuffleFromTo(int from, int to) {
	...
	org.ihtsdo.cern.jet.random.Uniform gen = new org.ihtsdo.cern.jet.random.Uniform(org.ihtsdo.cern.jet.random.Uniform.makeDefaultGenerator());
	for (int i=from; i<to; i++) { 
