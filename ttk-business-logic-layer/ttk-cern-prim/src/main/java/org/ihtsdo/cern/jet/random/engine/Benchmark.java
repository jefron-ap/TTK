 ...
 * generator = new org.ihtsdo.cern.jet.random.engine.MersenneTwister(new java.util.Date());
 ...
 *
 *
 * @see org.ihtsdo.cern.jet.random
...
public static void benchmark(int times) {
	org.ihtsdo.cern.colt.Timer timer = new org.ihtsdo.cern.colt.Timer();
	RandomEngine gen;
...
public static void test(int size, RandomEngine randomEngine) {
	...
	//cern.colt.Timer timer = new org.ihtsdo.cern.colt.Timer().start();
...
private static void xtestRandomFromTo(long from, long to, int times) {
	...
	//cern.colt.set.OpenMultiFloatHashSet multiset = new org.ihtsdo.cern.colt.set.OpenMultiFloatHashSet();
