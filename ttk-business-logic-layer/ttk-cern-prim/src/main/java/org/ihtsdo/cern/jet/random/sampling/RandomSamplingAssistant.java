...
*/
package org.ihtsdo.cern.jet.random.sampling;

import org.ihtsdo.cern.colt.list.BooleanArrayList;
 ...
 */
public class RandomSamplingAssistant extends org.ihtsdo.cern.colt.PersistentObject {
...
public static void test(long n, long N) {
	...
	org.ihtsdo.cern.colt.list.LongArrayList sample = new org.ihtsdo.cern.colt.list.LongArrayList((int)n);
