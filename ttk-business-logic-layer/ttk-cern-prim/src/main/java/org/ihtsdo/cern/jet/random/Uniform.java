...
/**
 * Constructs a uniform distribution with the given minimum and maximum, using a {@link org.ihtsdo.cern.jet.random.engine.MersenneTwister} seeded with the given seed.
 */
public Uniform(double min, double max, int seed) {
	this(min,max, new org.ihtsdo.cern.jet.random.engine.MersenneTwister(seed)); 
}
/**
