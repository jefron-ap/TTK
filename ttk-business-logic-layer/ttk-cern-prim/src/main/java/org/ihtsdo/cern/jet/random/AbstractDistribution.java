...
*/
package org.ihtsdo.cern.jet.random;

import org.ihtsdo.cern.jet.random.engine.RandomEngine;
/**
 ...
 * <p>
 * {@link org.ihtsdo.cern.jet.random.engine.MersenneTwister} is recommended as uniform pseudo-random number generation engine, since it is very strong and at the same time quick.
 * {@link #makeDefaultGenerator()} will conveniently construct and return such a magic thing.
 * You can also, for example, use {@link org.ihtsdo.cern.jet.random.engine.DRand}, a quicker (but much weaker) uniform random number generation engine.
 ...
 * <p>
 * @see org.ihtsdo.cern.jet.random.engine
 * @see org.ihtsdo.cern.jet.random.engine.Benchmark
 * @see org.ihtsdo.cern.jet.random.Benchmark
 * @author wolfgang.hoschek@cern.ch
 * @version 1.0, 09/24/99
 */
public abstract class AbstractDistribution extends org.ihtsdo.cern.colt.PersistentObject implements org.ihtsdo.cern.colt.function.DoubleFunction, org.ihtsdo.cern.colt.function.IntFunction {
 ...
 * Currently this is {@link org.ihtsdo.cern.jet.random.engine.MersenneTwister}.
 */
public static RandomEngine makeDefaultGenerator() {
	return org.ihtsdo.cern.jet.random.engine.RandomEngine.makeDefault();
}
/**
